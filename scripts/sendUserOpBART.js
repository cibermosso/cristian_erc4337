...
const sender ="0x9a49A5Fb3E5BFa6Cde568820205B2bCf881eEC26";  //smart contract wallet
...
//userOp.signature = await signer1.signMessage(hre.ethers.getBytes(userOpHash))+ signer2.signMessage(hre.ethers.getBytes(userOpHash));
