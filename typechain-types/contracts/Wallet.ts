...
export interface WalletInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "encodeSignatures",
    values: [BytesLike[]]
  ): string;
  encodeFunctionData(
...
export interface Wallet extends BaseContract {
  ...
  encodeSignatures: TypedContractMethod<
  ...
  walletFactory: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "encodeSignatures"
  ): TypedContractMethod<[signatures: BytesLike[]], [string], "view">;
  getFunction(
